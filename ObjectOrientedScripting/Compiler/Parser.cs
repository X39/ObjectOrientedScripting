...
public class Parser {
	...
	void IDENT(out pBaseLangObject outObj, pBaseLangObject parent) {
		Expect(3);
		var obj = new Ident(parent, t.val, t.line, t.col); outObj = obj;
	}
	...
	void CODEINSTRUCTION_SC(out pBaseLangObject outObj, pBaseLangObject parent) {
		...
		if (la.kind == 42) {
			...
			outObj.addChild(blo); 
		} else if (peekCompare(_T_IDENT, _T_IDENT) ) {
	...
	void OP_SWITCH(out pBaseLangObject outObj, pBaseLangObject parent) {
		...
		while (la.kind == 45 || la.kind == 46 || la.kind == 47) {
			if (la.kind == 45) {
				...
				if (la.kind == 46) {
					Get();
					caseObj = new Case(obj); obj.addChild(caseObj); caseObj.expression = new Ident(caseObj, "default", t.line, t.col); 
					Expect(29);
				} else {
					Get();
					caseObj = new Case(obj); obj.addChild(caseObj); caseObj.expression = new Ident(caseObj, "default", t.line, t.col); 
	...
	static readonly bool[,] set = {
		...
		{_x,_x,_x,_T, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_T, _T,_T,_T,_T, _T,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x},
...
public class Errors {
	...
	public virtual void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 59: s = "invalid NEWVARIABLE"; break;
			case 60: s = "invalid FUNCTION"; break;
			case 61: s = "invalid VFUNCTION"; break;
			case 62: s = "invalid VFUNCTION"; break;
			case 63: s = "invalid CODEINSTRUCTION"; break;
			case 64: s = "invalid CODEINSTRUCTION_SC"; break;
			case 65: s = "invalid CODEINSTRUCTION_NSC"; break;
			case 66: s = "invalid OP_FOR"; break;
			case 67: s = "invalid OP_WHILE"; break;
			case 68: s = "invalid OP_IFELSE"; break;
			case 69: s = "invalid OP_IFELSE"; break;
			case 70: s = "invalid OP_SWITCH"; break;
			case 71: s = "invalid OP_SWITCH"; break;
