...
namespace Compiler.OOS_LanguageObjects
{
    public class OosVariableAssignment : BaseLangObject
    {
        ...
        public BaseLangObject Variable { get { return this.Children[0]; } set { this.Children[0] = value; } }
        public BaseLangObject Value { get { return this.Children[1]; } set { this.Children[1] = value; } }
