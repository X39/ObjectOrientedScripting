...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "typeOf": t.kind = 49; break;
			case "instanceof": t.kind = 50; break;
			case "instanceOf": t.kind = 51; break;
			case "new": t.kind = 52; break;
			case "SQF": t.kind = 53; break;
			case "for": t.kind = 54; break;
			case "while": t.kind = 55; break;
			case "case": t.kind = 56; break;
			case "default": t.kind = 57; break;
			case "switch": t.kind = 58; break;
			case "try": t.kind = 59; break;
			case "catch": t.kind = 60; break;
			case "throw": t.kind = 61; break;
			case "return": t.kind = 62; break;
			case "isset": t.kind = 63; break;
			case "startnative": t.kind = 64; break;
			case "endnative": t.kind = 65; break;
			case "native": t.kind = 66; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 13:
				if (ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 14;}
				else {goto case 0;}
			case 14:
				recEnd = pos; recKind = 7;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 14;}
			...
			case 16:
				recEnd = pos; recKind = 7;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 16;}
				else {t.kind = 7; break;}
			case 17:
				{t.kind = 8; break;}
			case 18:
